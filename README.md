...
function showReserveOverlay(selectedCity = null) {
    ...
    const searchReserveItems = (searchTerm, category = 'All', city = null) => {
        ...
        const searchFilter = (item) => {
            ...
            const searchFields = [
                ...
                // Add additional searchable nested fields
